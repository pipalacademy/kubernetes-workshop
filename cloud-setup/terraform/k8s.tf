...
#   client_certificate     = "${base64decode(file("kube/client-cert.pem"))}"
#   client_key             = "${base64decode(file("kube/client-key.pem"))}"
#   cluster_ca_certificate = "${base64decode(file("kube/cluster-ca-cert.pem"))}"}
